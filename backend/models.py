...
class Event(models.Model):
    ...
    virtual_location = models.URLField(blank=True, null=True)  # Virtual link (Zoom, etc.)
    ...
    speakers = models.ManyToManyField(User, related_name="speaking_events", blank=True)
